...
const TYPE_CONFIG = {
  conflict: { icon: AlertTriangle, bg: "bg-rose-50 dark:bg-rose-900/20", border: "border-rose-100 dark:border-rose-800/40", text: "text-rose-700 dark:text-rose-400", iconColor: "text-rose-500 dark:text-rose-400" },
  warning: { icon: AlertTriangle, bg: "bg-amber-50 dark:bg-amber-900/20", border: "border-amber-100 dark:border-amber-800/40", text: "text-amber-700 dark:text-amber-400", iconColor: "text-amber-500 dark:text-amber-400" },
  suggestion: { icon: Lightbulb, bg: "bg-brand-50 dark:bg-brand-900/20", border: "border-brand-100 dark:border-brand-800/40", text: "text-brand-700 dark:text-brand-400", iconColor: "text-brand-500 dark:text-brand-400" },
  opportunity: { icon: TrendingUp, bg: "bg-emerald-50 dark:bg-emerald-900/20", border: "border-emerald-100 dark:border-emerald-800/40", text: "text-emerald-700 dark:text-emerald-400", iconColor: "text-emerald-500 dark:text-emerald-400" },
