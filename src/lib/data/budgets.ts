...
export const DEMO_BUDGET_ITEMS: BudgetLineItem[] = [
  { _id: "budget_001", eventId: "event_demo_001", category: "venue", label: "Meadowbrook Estate venue rental", projected: 3200, actual: 3200, vendorId: "vendor_003", isPaid: false, dueDate: "2025-08-18", notes: "Includes barn access + grounds. Deposit 50% due Aug 18." },
...
export const DEMO_TIMELINE_ITEMS: TimelineItem[] = [
  ...
  { _id: "tl_002", eventId: "event_demo_001", title: "Venue shortlist finalized", description: "Meadowbrook Estate selected as primary venue. Backup: Terrain Landscape Events.", type: "milestone", status: "completed", dueDate: "2025-07-22", completedAt: "2025-07-22", priority: "high", order: 2 },
  ...
  { _id: "tl_005", eventId: "event_demo_001", title: "Venue contract signing — Meadowbrook Estate", description: "50% deposit required at signing: $1,600.", type: "deadline", status: "pending", dueDate: "2025-08-18", priority: "critical", vendorId: "vendor_003", linkedBudgetId: "budget_001", order: 5 },
  ...
  { _id: "tl_011", eventId: "event_demo_001", title: "Site walk-through at Meadowbrook Estate", description: "Confirm setup zones, power access, parking, and contingency spaces.", type: "task", status: "pending", dueDate: "2025-09-15", priority: "high", vendorId: "vendor_003", order: 11 },
